    ...
    <footer className="w-full h-[72px] bg-black border-t border-zinc-800 flex-shrink-0 px-space-lg flex items-center justify-between select-none">
        ...
        {currentTrack && (
          <div className="flex items-center gap-1.5 ml-space-xs flex-shrink-0">
            <button
              ...
              className={`transition-colors flex items-center justify-center w-7 h-7 rounded-full hover:bg-zinc-800/80 ${liked ? 'text-red-500 hover:text-red-400' : 'text-zinc-400 hover:text-white'
                }`}
      ...
      <div className="flex flex-col items-center gap-space-xs w-2/4 max-w-xl">
        <div className="flex items-center gap-space-lg">
          ...
          <button
            ...
            className={`transition-colors flex items-center justify-center ${isShuffle ? 'text-white' : 'text-zinc-500 hover:text-white'
              }`}
          ...
          <button
            ...
            className={`transition-colors flex items-center justify-center ${repeatMode !== 'off' ? 'text-white' : 'text-zinc-500 hover:text-white'
              }`}
      ...
      <div className="flex items-center justify-end gap-3 w-1/4 min-w-[200px]">
        ...
        <button
          ...
          className={`relative w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${isQueueOpen
